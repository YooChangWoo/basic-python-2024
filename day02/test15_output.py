...
string_1 = '{}'.format(10) # {} 위치에 함수 뒤에 들어있는 값을 바꿔주고, 원하는 양식으로 표현
print(type(string_1))

name = '유창우'  # input('이름 입력 > ')
...
print(string_3)
#정수를 문자열 포맷
# =: 기호와 숫자를 분리, 02d: 두자리 수 만들때 빈자리 0으로 채우기, d:정수
string_4 = '______{:=+010d}______'.format(-100)
print(string_4)
# 실수 문자열포맷 f (기본 소수점 6자리)
# 7.2f 전체 자리수를 7자리로, 소수점 뒤는 2자리
val = 78.33333333
...
print(string_7.lower().capitalize()) # 모두 소문자로

print(string_7.split()) # 특정한 단어로 자르는 함수

string_8 = 'Hello, I am MG Chang. I am a lecturer. Good Luck for your day.'
...
print('안녕' in '안녕하세요')  # 문장안에 단어가 있는 지 확인
